...
class App(customtkinter.CTk):
    ...
    def fetch_levels_for_accounts(self, accounts):
        self.log_manager.add_log("ℹ️ Парсинг уровня/опыта отключен")
        return 0
    ...
    def _build_functional_section(self, parent):
        ...
        customtkinter.CTkLabel(self.srt_placeholder, text="Steam Route Tool", text_color=TXT_MUTED, font=customtkinter.CTkFont(size=14, weight="bold")).grid(row=0, column=0, padx=8, pady=(8, 3), sticky="w")
        customtkinter.CTkLabel(self.srt_placeholder, text="SRT отключен по ТЗ", text_color=TXT_MUTED, font=customtkinter.CTkFont(size=11)).grid(row=1, column=0, padx=8, pady=(0, 8), sticky="w")
    ...
    def _build_config_section(self, parent):
        ...
        customtkinter.CTkLabel(header, text="Настройте автологику и пути Steam/TF2 в одном месте", font=customtkinter.CTkFont(size=11), text_color=TXT_MUTED).grid(row=1, column=0, pady=(4, 0), sticky="w")
    ...
    def _telegram_get_launched_levels(self):
        return "Level/XP parsing disabled"
